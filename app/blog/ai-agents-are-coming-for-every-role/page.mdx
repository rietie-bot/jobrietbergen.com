...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://blog.kilo.ai/p/ai-agents-are-coming-for-every-role',
  },
  openGraph: {
    images: [
      {
        url: '/blog/ai-agents-are-coming-for-every-role/meta-image.jpg',
        width: 1200,
        height: 675,
      },
    ],
  ...
  twitter: {
    ...
    images: ['/blog/ai-agents-are-coming-for-every-role/meta-image.jpg'],
  },
};
...
## Developers were first. Everyone else is <s>next</s> now.
...
<CrossPostNotice url="https://blog.kilo.ai/p/ai-agents-are-coming-for-every-role" />
